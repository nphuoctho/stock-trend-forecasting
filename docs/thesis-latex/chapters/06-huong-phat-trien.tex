...
\begin{enumerate}[nosep]
  ...
  \item \textbf{Biến thể PhoBERT kết hợp CNN hoặc BiLSTM.} Với 306 mẫu và 31 mẫu lớp tiêu
        cực, khoảng tin cậy của độ bao phủ lớp này rộng $\pm0{,}176$, nên một so sánh giữa
        hai kiến trúc phân loại sẽ không phân biệt được chúng về mặt thống kê. Việc so sánh
        chỉ có ý nghĩa sau khi tập nhãn được mở rộng; hạ tầng rút mẫu cho bước mở rộng này
        đã được chuẩn bị và trình bày ở Mục~\ref{sec:kq-mornhan}.
...
Ưu tiên cao nhất trong số các hướng của chương này là mở rộng tập nhãn cảm xúc, vì đây là
giới hạn đã được xác định là quyết định ở Chương~\ref{ch:ket-luan}: nếu không nâng được độ
bao phủ của các lớp biên, không thể tách được hai cách giải thích cho kết luận âm --- tín
hiệu cảm xúc yếu, hay bộ sinh cảm xúc yếu.

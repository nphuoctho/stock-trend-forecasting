...
\begin{enumerate}[nosep]
  \item \textbf{Temporal Fusion Transformer.} Chương~\ref{ch:phuong-phap} đã đặt TFT ở vị
        ...
        hồi cứu ở Chương~\ref{ch:ket-qua} chưa cung cấp bằng chứng ngoài mẫu về đóng góp của
        cảm xúc, nên ưu tiên đúng là hoàn tất đánh giá không rò rỉ thời điểm trước khi tăng
        độ phức tạp của bộ dự báo. Khi thực hiện, TFT cần được cấu hình cho phân loại ba lớp
        và chạy trên đúng các đoạn kiểm thử cuốn chiếu; phần quan trọng của biến và cơ chế
        chú ý chỉ được diễn giải như mô tả phụ thuộc mô hình, không phải bằng chứng nhân quả.

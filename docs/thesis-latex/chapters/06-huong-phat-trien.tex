...
\begin{enumerate}[nosep]
  ...
  \item \textbf{Biến thể PhoBERT kết hợp CNN hoặc BiLSTM.} Lượt chạy đang báo cáo có
        306 mẫu và 31 mẫu lớp tiêu cực, nên chưa đủ để phân biệt hai kiến trúc phân
        loại về mặt thống kê. Tập 1.306 nhãn đã được rà soát đã sẵn sàng; cần hoàn
        thành xác thực chéo phân tầng trên tập này trước, rồi mới quyết định so sánh
        các biến thể kiến trúc ở Mục~\ref{sec:kq-mornhan}.
...
Ưu tiên cao nhất trong số các hướng của chương này là hoàn thành xác thực chéo phân tầng
trên tập 1.306 nhãn cảm xúc đã rà soát. Chỉ sau khi có độ bao phủ các lớp biên mới, đồ án
mới có thể tách hai cách giải thích cho kết luận âm --- tín hiệu cảm xúc yếu, hay bộ sinh
cảm xúc yếu.

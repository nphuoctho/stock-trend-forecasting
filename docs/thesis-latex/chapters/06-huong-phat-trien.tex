...
\begin{enumerate}[nosep]
  ...
  \item \textbf{Biến thể PhoBERT kết hợp CNN hoặc BiLSTM.} Xác thực chéo trên 1.306 mẫu
        đã cho mức đo lớp NEGATIVE tốt hơn. Điểm kiểm triển khai đã được truyền sang nhánh
        dự báo hồi cứu, nhưng đánh giá ngoài mẫu còn thiếu vì điểm kiểm này chứa nhãn sau
        các ngày kiểm thử. Trước khi so sánh biến thể kiến trúc, cần tinh chỉnh lại trong
        từng cửa sổ chỉ bằng nhãn quá khứ, hoặc đóng băng một điểm kiểm trước ngày kiểm thử
        đầu tiên, rồi chấm lại kho tin và chạy đối chứng.
...
Ưu tiên cao nhất trong số các hướng của chương này là đánh giá không rò rỉ thời điểm: tinh
chỉnh lại bộ sinh cảm xúc trong từng cửa sổ chỉ bằng nhãn quá khứ, hoặc dùng một điểm kiểm
đóng băng trước ngày kiểm thử đầu tiên, sau đó chấm lại kho tin và chạy lại dự báo cùng đối
chứng. Chỉ chuỗi thực nghiệm này mới cung cấp bằng chứng ngoài mẫu về tín hiệu cảm xúc.

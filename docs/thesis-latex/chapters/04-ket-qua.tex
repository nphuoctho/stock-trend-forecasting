...
Trước khi dùng đầu ra cảm xúc cho dự báo, báo cáo phải ghi số người rà soát, tiêu chí,
số mẫu được rà soát, các trường hợp cần chỉnh sửa và phân bố ba lớp. Mô hình ngôn ngữ
lớn chỉ tạo nhãn sơ bộ; một người duy nhất kiểm tra toàn bộ mẫu. Do không có người gán
...
\begin{table}[H]
  ...
  \begin{tabular}{p{6.2cm} c}
    ...
    Số mẫu cần chỉnh sửa sau nhãn sơ bộ & \textit{Chưa điền} \\
    \bottomrule
  \end{tabular}
\noindent\textit{Nguồn: Tác giả xây dựng.}
\end{table}

...
\begin{itemize}[nosep]
  ...
  \item Xây dựng và chạy thử pipeline tinh chỉnh PhoBERT cho phân loại cảm xúc ba lớp.
\end{itemize}
...
có thể truy nguyên đã cơ bản đạt được, do dữ liệu giá và tin tức đều có nguồn, mốc thời
gian và độ phủ rõ ràng. Các mục tiêu còn lại, gồm đánh giá PhoBERT ở tầng cảm xúc, kết
hợp hai nguồn dữ liệu, huấn luyện mô hình dự báo và đo phần đóng góp của cảm xúc, đang
trong giai đoạn thực hiện và sẽ được trả lời bằng số liệu ở Chương~\ref{ch:ket-qua}.
...
\begin{enumerate}[nosep]
  \item Tinh chỉnh PhoBERT trên GPU, sinh xác suất cảm xúc cho toàn bộ corpus tin tức.
        Dự kiến hoàn thành trong tuần đầu tháng 9.
  \item Tổng hợp cảm xúc theo mã và ngày giao dịch, ghép với đặc trưng giá, tạo nhãn ba lớp.

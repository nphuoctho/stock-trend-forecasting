...
\begin{itemize}[nosep]
  ...
  \item Thu thập và kiểm tra dữ liệu: giá của 10 mã VN30 trong giai đoạn 2020 đến hết năm
        2025, cùng 10.695 bài tin tức Vietstock có mốc thời gian đến phút và nội dung bài.
...
\begin{enumerate}[nosep]
  ...
  \item Chạy các mô hình đối chứng và LSTM hai nhánh, thực hiện thí nghiệm loại bỏ đặc
        trưng có và không có cảm xúc, kèm khoảng tin cậy.
  \item Điền kết quả vào Chương~\ref{ch:ket-qua}, hoàn thiện kết luận định lượng và nộp
        trước hạn ngày 23 tháng 9 năm 2026.
\end{enumerate}

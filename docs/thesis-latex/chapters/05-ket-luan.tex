...
\begin{itemize}[nosep]
  \item hiệu số trực tiếp: $+0{,}0025$ F1 vĩ mô;
  \item trong đó hiệu ứng kiến trúc, sự hiện diện và khối lượng tin: $-0{,}0015$;
  \item đóng góp thông tin phân cực: $+0{,}0040$ theo cửa sổ; ước lượng theo ngày là
        $-0{,}0013$, khoảng tin cậy 95\% $[-0{,}0105; +0{,}0082]$.
\end{itemize}
...
công bố trước ngày quan sát kiểm thử đầu tiên (22/10/2024), rồi chấm lại toàn bộ 12.140 bài
tin (14.256 liên kết tin--mã) và chạy lại thang dự báo cùng đối chứng ghép cặp. Với điểm
kiểm đóng băng, đóng góp thông tin phân cực ở LSTM hai nhánh --- nhánh chính của đồ án ---
là $-0{,}0024$ F1 vĩ mô, khoảng tin cậy theo ngày $[-0{,}0134; +0{,}0079]$. Ở TFT, ước
lượng điểm là $+0{,}0061$ nhưng cả khoảng theo ngày $[-0{,}0041; +0{,}0181]$ lẫn khoảng
theo cửa sổ $[-0{,}0008; +0{,}0143]$ đều chứa 0, nên không được dùng làm bằng chứng.

So với lượt hồi cứu, chỉ ước lượng theo cửa sổ đổi dấu ($+0{,}0040 \to -0{,}0024$); ước
lượng theo ngày, vốn là căn cứ chính, đã âm ở cả hai lượt ($-0{,}0013 \to -0{,}0029$).
Độ dịch chuyển nằm trong bề rộng khoảng tin cậy của cả hai lượt và có ít nhất hai cách
giải thích mà đồ án không tách được: rò rỉ thời điểm qua bộ sinh ở lượt hồi cứu, và việc
điểm kiểm đóng băng chỉ học từ 1.049 thay vì 1.306 nhãn nên yếu hơn. Phép tách cần một lượt
huấn luyện trên 1.049 nhãn lấy ngẫu nhiên không theo thời gian; hạng mục này chưa thực hiện.
...
điểm và số lượng tin, lượt hồi cứu cho đóng góp thông tin theo cửa sổ $+0{,}0040$ F1 vĩ mô
(theo ngày $-0{,}0013$, khoảng tin cậy $[-0{,}0105; +0{,}0082]$).

Lượt ngoài mẫu với điểm kiểm đóng băng trước ngày kiểm thử đầu tiên cho $-0{,}0024$ F1 vĩ
mô ở LSTM hai nhánh, nhánh chính của đồ án (khoảng tin cậy theo ngày
$[-0{,}0134; +0{,}0079]$). Ở TFT ước lượng điểm là $+0{,}0061$ nhưng cả hai khoảng tin cậy
đều chứa 0. Không ước lượng nào loại trừ 0, và ở nhánh chính không còn ước lượng điểm
dương. Độ dịch chuyển so với lượt hồi cứu nằm trong bề rộng khoảng tin cậy và chưa tách
được giữa rò rỉ thời điểm và việc điểm kiểm đóng băng học từ ít nhãn hơn.
...
phủ tin, có điểm kiểm phù hợp thời điểm, và có đủ bản kê để tái lập --- thay vì một ước

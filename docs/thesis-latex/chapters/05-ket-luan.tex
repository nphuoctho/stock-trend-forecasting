...
nhãn gồm cả giai đoạn kiểm thử nên là lượt hồi cứu. Giao thức cho một lượt ngoài mẫu
hợp lệ --- điểm kiểm đóng băng trước ngày kiểm thử đầu tiên --- đã được cài đặt và xác
minh, nhưng chưa được đo.
...
Giao thức cho đánh giá ngoài mẫu đã được cài đặt và khóa: một điểm kiểm tinh chỉnh chỉ
trên 1.049 nhãn công bố trước ngày quan sát kiểm thử đầu tiên (21/10/2024), cùng một điểm
kiểm đối chứng rút đúng số nhãn mỗi lớp đó nhưng từ mọi mốc thời gian, để tách ảnh hưởng
của việc loại nhãn tương lai khỏi ảnh hưởng của việc huấn luyện trên ít dữ liệu hơn. Lệnh
\texttt{forecast} xác minh mã băm bản kê điểm kiểm và ghi \texttt{point\_in\_time} kèm lý
do vào tệp kết quả, nên chỉ artifact được xác minh mới có thể dùng làm bằng chứng.

Hai điểm kiểm này cần GPU và được huấn luyện ngoài máy phát triển; kết quả chưa được đo
nên đồ án không đưa ra con số ngoài mẫu nào. Kết luận hiện có là kết luận hồi cứu: trên
bộ dữ liệu và thiết lập này, \textbf{chưa có bằng chứng rằng cảm xúc tin tài chính tiếng
Việt cải thiện dự báo xu hướng phiên kế tiếp}.
...
Lượt ngoài mẫu chưa được đo. Giao thức của nó --- điểm kiểm đóng băng trước ngày kiểm
thử đầu tiên, cùng một điểm kiểm đối chứng khớp kích thước và phân bố lớp --- đã được
cài đặt, kiểm chứng bằng mã băm và pin bằng kiểm thử tự động, nhưng cần GPU ngoài máy
phát triển. Đồ án vì vậy không trình bày con số ngoài mẫu nào.

Kết luận trong phạm vi đã đo là: trên 10 mã HOSE giai đoạn 2020--2025 với nguồn tin
Vietstock và chân trời một phiên, \textbf{chưa có bằng chứng rằng cảm xúc tin tài chính
tiếng Việt cải thiện dự báo xu hướng phiên kế tiếp}. Giá trị của đồ án nằm ở chỗ phát
biểu này được rút ra từ một quy trình đo có đối chứng ghép cặp giữ nguyên kiến trúc và
độ phủ tin, và ghi rõ ranh giới giữa điều đã đo với điều chưa đo --- thay vì một ước
lượng điểm dương báo cáo mà không kiểm tra thời điểm của bộ sinh.

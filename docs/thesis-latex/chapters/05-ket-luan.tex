...
\begin{itemize}[nosep]
  ...
  \item đóng góp thông tin phân cực: $+0{,}0080$ theo cửa sổ; khoảng tin cậy 95\%
        theo ngày $[-0{,}0025; +0{,}0186]$.
\end{itemize}
...
$+0{,}0094$ F1 vĩ mô theo cửa sổ, với khoảng tin cậy 95\% theo cửa sổ
$[-0{,}0022; +0{,}0243]$ và theo ngày $[-0{,}0009; +0{,}0196]$; lượt đối chứng
cùng kích thước cho $+0{,}0028$ theo cửa sổ, khoảng tin cậy theo ngày
$[-0{,}0074; +0{,}0133]$. Trong lần rút hạt giống 7, điểm kiểm đóng băng cho ước
lượng cao hơn đối chứng, nhưng đây là kết quả thăm dò từ một lần rút mẫu duy nhất,
chưa tách chắc ảnh hưởng thời điểm khỏi thành phần mẫu; mọi khoảng tin cậy theo
ngày vẫn chứa 0.

Kết luận hiện có, tính cả lượt ngoài mẫu và các phân tích bổ sung bên dưới: trên
bộ dữ liệu và thiết lập này, \textbf{chưa có bằng chứng đủ mạnh rằng cảm xúc tin
tài chính tiếng Việt cải thiện dự báo xu hướng phiên kế tiếp}. Với TFT, đóng góp
thông tin không dương ở bất kỳ bộ sinh nào.

Ba phân tích bổ sung hướng trực tiếp vào giá trị thông tin --- tương quan hạng
của tín hiệu không qua mô hình (Mục~\ref{sec:kq-ic}), nhãn lợi suất vượt trội
(Mục~\ref{sec:kq-excess}) và ablation chân trời dự báo
(Mục~\ref{sec:kq-horizon}) --- đều không tìm thấy cải thiện có thể tái lập; phân
tích thứ tư là chẩn đoán kinh tế (Mục~\ref{sec:kq-kinh-te}) phục vụ câu hỏi
giá trị giao dịch. Mỗi phép có giới hạn riêng cần giữ đúng khi diễn giải. Tương quan
hạng chỉ bác bỏ liên hệ đơn điệu của một điểm số vô hướng cụ thể ở chân trời một
phiên, không phải cận trên của khả năng dự báo và không loại trừ quan hệ phi
tuyến, có điều kiện, một cách đo cảm xúc khác hay một cách tổng hợp khác; phép
đối chiếu này mang tính thăm dò, chưa được đăng ký trước. Nhãn lợi suất vượt
trội chỉ cho thấy mọi nhánh đều đạt F1 vĩ mô thấp hơn --- một quan sát về độ khó
của bài toán gán nhãn thay thế, không phải phân rã phương sai hay nhân quả, và
vì dùng chung bộ dữ liệu với các phân tích còn lại nên không phải một xác nhận
độc lập. Ablation chân trời cho hình mẫu không đơn điệu, và ở $h > 1$ các nhãn
chồng lấn nên khoảng tin cậy hẹp hơn mức bằng chứng cho phép, nên không xác lập
được sự phụ thuộc của đóng góp cảm xúc vào chân trời. Chẩn đoán kinh tế chỉ là
cận trên dưới giả định khớp lệnh hoàn hảo: sổ lệnh vào lệnh tại chính giá đóng
cửa mà tín hiệu vừa sử dụng nên không giao dịch được, $23{,}2\%$ số phiên chỉ có
lệnh một chiều nên sổ lệnh không trung hòa thị trường, và 300 phiên kiểm thử
không đủ để tách các mức Sharpe gần nhau.
...
Cần nói rõ giới hạn của phần vận hành này: \textbf{sổ theo dõi trực tuyến hiện chưa có dòng
dự báo hợp lệ nào}. Một dòng chỉ được tính vào sổ khi nó được phát hành trước phiên khớp
lệnh mở cửa của phiên mục tiêu; toàn bộ các dòng đã đối soát đến nay đều được đóng dấu sau
thời điểm đó nên bị xếp là chạy lại và bị loại khỏi thống kê. Nguyên nhân không phải lỗi
vận hành đơn lẻ mà là ràng buộc của nguồn dữ liệu: nhà cung cấp giá chỉ công bố giá đóng
cửa của một phiên vào ngày hôm sau, nên quan sát mới nhất tại mọi thời điểm luôn là phiên
liền trước. Lịch chạy sau giờ đóng cửa vì thế luôn tạo ra các dòng chạy lại. Lịch khả thi
duy nhất là chạy vào buổi sáng, sau khi giá của phiên liền trước đã được công bố qua đêm và
trước phiên khớp lệnh mở cửa lúc 09:00; hệ thống hiện cảnh báo ngay tại thời điểm phát hành
khi một lần chạy không thể được tính là dự báo trước.

Hệ quả cho việc đọc kết quả: phần vận hành chứng minh đường xử lý chạy được đầu--cuối và cơ
chế đóng dấu phát hành hoạt động đúng, \textbf{không} cung cấp bất kỳ bằng chứng hiệu năng
trực tuyến nào. Mọi con số hiệu năng trong đồ án đều đến từ đánh giá cuốn chiếu ngoài mẫu ở
Chương~\ref{ch:ket-qua}, không đến từ vận hành thực tế.
...
trúc, thời điểm và số lượng tin, đóng góp thông tin phân cực là $+0{,}0080$ F1
vĩ mô theo cửa sổ, với khoảng tin cậy theo ngày $[-0{,}0025; +0{,}0186]$ chứa 0.
...
Lượt ngoài mẫu đã được đo và xác minh (\texttt{point\_in\_time: true}): điểm
kiểm đóng băng trước ngày kiểm thử đầu tiên cho đóng góp thông tin $+0{,}0094$
F1 vĩ mô theo cửa sổ, với khoảng tin cậy theo ngày $[-0{,}0009; +0{,}0196]$ chứa
0. Điểm kiểm đối chứng khớp kích thước và phân bố lớp (hạt giống 7, thăm dò)
cho $+0{,}0028$ theo cửa sổ, khoảng tin cậy theo ngày $[-0{,}0074; +0{,}0133]$
cũng chứa 0 --- ước lượng điểm thấp hơn điểm kiểm đóng băng trong lần rút này,
nhưng một lần rút mẫu chưa tách chắc ảnh hưởng thời điểm khỏi thành phần mẫu.
...
tin tài chính tiếng Việt cải thiện dự báo xu hướng phiên kế tiếp}. Bốn phân tích
bổ sung ở các Mục~\ref{sec:kq-ic}, \ref{sec:kq-excess}, \ref{sec:kq-horizon}
và~\ref{sec:kq-kinh-te} không nới lỏng phát biểu này, khi giữ đúng các giới hạn
riêng đã nêu của từng phép. Giá trị của đồ án nằm ở chỗ

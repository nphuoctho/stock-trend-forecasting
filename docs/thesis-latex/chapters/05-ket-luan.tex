...
đoạn kiểm thử cuốn chiếu không chồng lấn. Tuy nhiên, lượt hồi cứu hiện tại dùng điểm kiểm
cảm xúc học từ nhãn gồm cả giai đoạn kiểm thử, nên không được diễn giải là dự báo ngoài mẫu.
...
Mô hình LSTM chỉ giá đạt F1 vĩ mô 0,3797, độ chính xác cân bằng 0,3915 và AUC-ROC
một-chống-còn-lại 0,5721; các điểm này cao hơn mốc ngẫu nhiên 0,3289 và mốc lớp
phổ biến 0,1603. Báo cáo không có kiểm định ghép cặp với hai mốc đối chứng, nên
so sánh này chỉ mô tả mức điểm quan sát được. Các điểm
số của nhánh có cảm xúc dùng bộ sinh học từ nhãn tương lai tương đối với các cửa sổ
kiểm thử, nên chỉ có giá trị mô tả hồi cứu
...
\begin{itemize}[nosep]
  ...
  \item trong đó hiệu ứng kiến trúc và sự hiện diện tin: $+0{,}0044$;
...
có điểm cao hơn hai mốc đối chứng bắt buộc; do chưa có kiểm định ghép cặp với các mốc
này, kết quả chỉ mô tả mức điểm quan sát được.

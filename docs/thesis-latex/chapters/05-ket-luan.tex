...
Phần chưa hoàn thành là tinh chỉnh lại hoặc tổ hợp các điểm kiểm, chấm lại kho tin và
chạy lại dự báo cùng đối chứng; sau đó mới đánh giá biến thể PhoBERT kết hợp CNN hoặc BiLSTM.
...
chưa tách được hoàn toàn}. Độ bao phủ NEGATIVE 0,6803 trên 59 mẫu kiểm thử ngoài cho thấy
cấu hình mới tốt hơn lượt lịch sử, nhưng xác thực chéo chỉ đánh giá chất lượng phân loại.
Để kiểm tra liệu kết luận ``chưa có bằng chứng cải thiện'' do tín hiệu cảm xúc yếu hay do
bộ sinh lịch sử yếu, cần tinh chỉnh lại hoặc tổ hợp điểm kiểm mới, chấm lại kho tin theo
mốc cắt thông tin, rồi chạy lại dự báo và đối chứng. Ngoài ra, nhãn ba lớp buộc phải nén
các bài có nhiều sự kiện trái chiều về một lớp duy nhất.

...
riêng trước khi ghép biểu diễn và phân loại. Bộ biến đổi hợp nhất theo thời gian được xem là
...
bằng độ chính xác, độ chính xác dương tính, độ bao phủ, F1 theo lớp, F1 vĩ mô và ma trận nhầm lẫn. Tầng thứ
hai báo cáo F1 vĩ mô, độ chính xác cân bằng, AUC-ROC một-chống-còn-lại và các chỉ số theo lớp cho bài
toán dự báo, cùng chênh lệch giữa hai cấu hình loại bỏ đặc trưng. Khi số cửa sổ đủ lớn,
độ không chắc chắn của chênh lệch có thể được ước lượng bằng lấy mẫu lặp theo khối ngày
hoặc theo phần chia.

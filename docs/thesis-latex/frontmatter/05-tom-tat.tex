...
tin sau mốc cắt thông tin, tin cuối tuần hoặc tin vào ngày nghỉ được ánh xạ sang phiên
giao dịch kế tiếp. Tại ngày quan sát $t$, hệ thống chỉ sử dụng thông tin có thể biết đến
...
Cấu hình cơ sở là LSTM hai nhánh, trong đó nhánh thị trường và nhánh cảm xúc được xử lý
riêng trước khi ghép biểu diễn và phân loại. Temporal Fusion Transformer được xem là
phương án mở rộng khi dữ liệu, tài nguyên và kết quả của cấu hình cơ sở cho phép.
...
Dữ liệu được chia theo thứ tự thời gian bằng kiểm định cuốn chiếu (walk-forward), có tập
...
Ở thời điểm khóa dữ liệu hiện tại, kho tin đã lưu 10.695 bản ghi có URL, thời điểm
đăng và nội dung, kết hợp với 12.624 liên kết tin tức và mã cổ phiếu thuộc 10 mã
VN30. Các tệp giá hiện có gồm 15.744 dòng dữ liệu OHLCV, còn tập hạt giống CafeF
gồm 999 mẫu. Đây là kết quả của giai đoạn chuẩn bị dữ liệu; các chỉ số đánh giá
PhoBERT và mô hình dự báo chỉ được công bố sau khi hoàn thành huấn luyện theo đúng
giao thức.
